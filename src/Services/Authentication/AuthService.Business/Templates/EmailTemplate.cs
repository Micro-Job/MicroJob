...
public class EmailTemplate(IConfiguration _configuration)
{
    ...
    public string VerifyEmail(string fullName, string userId)
    {
                      ...
                      <table width=""536"" cellpadding=""0"" cellspacing=""0""  style=""background-color:#ffffff; border-radius:16px; padding:32px 40px; border: 0; box-sizing: border-box;"">
                        ...
                        <tr>
                          <td style=""padding-bottom: 20px; color:#303C4A; font-size:14px; line-height:1.4; font-weight: 400; text-align: center; box-sizing: border-box; box-sizing: border-box;"">
                            ...
                            Sizi burada görməkdən məmnunuq.<br />
                            İndi hesabınıza daxil olaraq imkanlarımızdan tam şəkildə yararlana bilərsiniz.<br />
                            Hesabınızı təsdiq etmək üçün:
                          </td>
                        </tr>
                        <!-- Button -->
                        <tr>
                          <td style=""text-align: center; box-sizing: border-box;"">
                            <a href=""{host}?userId={userId}"" style=""background-color:#0068F7; color:#fff; padding:7.5px 75px; text-decoration:none; border-radius:12px; border: 1px solid #8ABAFB; font-size:14px; line-height: 1.5; font-weight: 500; display:inline-block; box-sizing: border-box;"">
                              Hesabı təsdiq et
                            </a>
                          </td>
                        </tr>
    ...
    public string VerifyUpdateEmail(string fullName, string userId)
    {
    ...
    public string ApplicationMessage(string fullName, string message, string applicationId)
    {
        string host = _configuration["GetApplicationUrl"]!;
        ...
        return $@"
            ...
            <html>
              <head>
                <meta charset=""UTF-8"" />
                <title>Müraciətinizin statusu dəyişdi</title>
                <style>
                </style>
              </head>
              <body align=""center"" style=""width: 600px; margin:0 auto; padding:0; background-color:#f0f4ff; font-family:Poppins, Arial, sans-serif; box-sizing: border-box;"">
                  ...
                  <tr>
                    <td style=""text-align: center;"">
                      ...
                      <table width=""536"" cellpadding=""0"" cellspacing=""0""  style=""border-radius:16px; padding-bottom:20px; border: 0; box-sizing: border-box;"">
                        ...
                        <tr>
                          <td style=""font-size:20px; color:#3D4C5E; font-weight:600; line-height: 1.5; text-align: center; box-sizing: border-box;"">
                            Müraciətinizin statusu dəyişdi
                          </td>
                        </tr>
                      </table>
                      ...
                      <table width=""536"" cellpadding=""0"" cellspacing=""0""  style=""background-color:#ffffff; border-radius:16px; padding:32px 40px; border: 0; box-sizing: border-box;"">
                        ...
                        <tr>
                          <td style=""text-align: center; box-sizing: border-box;"">
                            <a href=""{host}/{applicationId}"" style=""background-color:#0068F7; color:#fff; padding:7.5px 75px; text-decoration:none; border-radius:12px; border: 1px solid #8ABAFB; font-size:14px; line-height: 1.5; font-weight: 500; display:inline-block; box-sizing: border-box;"">
                              Keçid et
                            </a>
                          </td>
                        </tr>
