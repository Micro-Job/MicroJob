...
namespace JobPayment.DAL.Migrations
{
    ...
    [Migration("20250407101935_CreatedPriceTables")]
    partial class CreatedPriceTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPayment.Core.Entities.OldPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JobPayment.Core.Entities.Price", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JobPayment.Core.Entities.OldPrice", b =>
                {
                    b.HasOne("JobPayment.Core.Entities.Price", "Price")
                        .WithMany("OldPrices")
