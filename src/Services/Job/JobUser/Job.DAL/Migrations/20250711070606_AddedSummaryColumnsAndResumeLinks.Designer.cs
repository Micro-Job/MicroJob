...
namespace Job.DAL.Migrations
{
    ...
    [Migration("20250711070606_AddedSummaryColumnsAndResumeLinks")]
    partial class AddedSummaryColumnsAndResumeLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Job.Core.Entities.ResumeLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Job.Core.Entities.SavedResume", b =>
                {
                    ...
                    b.HasIndex("ResumeId", "CompanyUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Job.Core.Entities.SavedResume", b =>
                {
                    ...
                    b.HasOne("Job.Core.Entities.User", null)
                        .WithMany("SavedResumes")
