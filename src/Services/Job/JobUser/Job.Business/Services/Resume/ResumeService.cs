...
namespace Job.Business.Services.Resume
{
    public class ResumeService : IResumeService
    {
        ...
        //     if (!resumeCreateDto.IsMainNumber)
        //     {
        //         numbers = await _numberService.CreateBulkNumberAsync(resumeCreateListsDto.NumberCreateDtos.PhoneNumbers);
        //     }
        //     else
        //     {
        //         var mainNumber = await _userInformationService.GetUserDataAsync(userGuid).Select(x => new Core.Entities.Number
        ...
        //     var educations = await _educationService.CreateBulkEducationAsync(resumeCreateListsDto.EducationCreateDtos.Educations);
        //     var experiences = await _experienceService.CreateBulkExperienceAsync(resumeCreateListsDto.ExperienceCreateDtos.Experiences);
        //     var languages = await _languageService.CreateBulkLanguageAsync(resumeCreateListsDto.LanguageCreateDtos.Languages);
        //     var certificates = resumeCreateDto.Certificates != null
        //         ? await _certificateService.CreateBulkCertificateAsync(resumeCreateDto.Certificates)
        //         : new List<Core.Entities.Certificate>();
