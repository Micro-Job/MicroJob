    ...
    public class UpdateVacancyDtoValidator : AbstractValidator<UpdateVacancyDto>
    {
        public UpdateVacancyDtoValidator()
        {
            RuleFor(x => x.Id)
                ...
                .Must(IsValidGuid).WithMessage("Vacancy ID must be a valid GUID.");

            RuleFor(x => x.CompanyId)
                .NotEmpty().WithMessage("Company ID cannot be empty.")
                .Must(IsValidGuid).WithMessage("Company ID must be a valid GUID.");
            ...
            RuleFor(x => x.CountryId)
                .Must(IsValidGuid).WithMessage("Country ID must be a valid GUID.")
                .When(x => !string.IsNullOrWhiteSpace(x.CountryId));

            RuleFor(x => x.CityId)
                .Must(IsValidGuid).WithMessage("City ID must be a valid GUID.")
            ...
            RuleFor(x => x.CategoryId)
                .Must(IsValidGuid).WithMessage("Category ID must be a valid GUID.")
